...
> **Version** : 0.14.0 | **Date** : 2026-08-15 | **Auteur** : Cloud Temple
...
```json
{"status": "healthy", "service": "mcp-vault", "version": "0.12.0", "transport": "streamable-http"}
```
