...
> **Version** : v0.15.0 — Une clé de provisionnement déjà engagée n'est plus jamais rejouable : un échec postérieur à l'appel OpenBao bloque désormais la clé (`operation_failed`), là où le rejeu créait une seconde enveloppe pendant que la première pouvait vivre sans être révocable
